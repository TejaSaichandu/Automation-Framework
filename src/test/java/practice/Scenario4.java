...
public class Scenario4 {
	...
	public static void main(String[] args) {
		...
		//step 7
		WebElement ele1 = dr.findElement(By.xpath("//select[@name='accounttype']"));
		...
		String elem3 = dr.findElement(By.xpath("//span[@id='dtlview_Type']")).getText();
		if((elem1.equals("UZUMAKI"))&&(elem2.equals("Chemicals"))&&(elem3.equals("Customer"))) {
